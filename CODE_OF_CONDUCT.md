...
This Code of Conduct applies to every repository in the [Bitwise Media Group][org] organisation — it lives here in the
`.github` repo so it applies by default everywhere. It sits alongside our [contributing guidelines](CONTRIBUTING.md),
which cover the day-to-day expectations for working together.
...
Instances of abusive, harassing, or otherwise unacceptable behaviour may be reported to the maintainers responsible for
enforcement. As with [security reports](SECURITY.md), please keep reports private rather than raising them in public
